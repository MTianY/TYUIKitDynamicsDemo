...
- (UIAttachmentBehavior *)attachmentBehavior {
    if (nil == _attachmentBehavior) {
        _attachmentBehavior = [[UIAttachmentBehavior alloc] initWithItem:self.imageView_first attachedToAnchor:CGPointMake(self.imageView_first.center.x,self.imageView_first.center.y)];
    }
...
- (void)panMethod:(UIPanGestureRecognizer *)pan {
    ...
    NSLog(@"%zd",panPoint);
    self.imageView_first.center = panPoint;
